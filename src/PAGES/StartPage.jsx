...
function StartPage() {
    ...
    return(
        <section className="startPage">
            ...
            <p className="welcomeTextStartPage">
                Safely leave your dog with our doggy care since we know what your best friend means to you. 
                <br></br>We value good relationships and prioritise security and a safe environment for your dog!
                <br></br><br></br>
